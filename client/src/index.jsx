...
class BookingModule extends React.Component {
  ...
  render() {
    const isDayBlocked = day =>
      this.state.blockedDates.filter(d => d.isSame(day, "day")).length > 0;
    if (this.state.bookingData) {
      return (
        <div className="app">
          <header className="Nav">
            ${this.state.bookingData.price} per night
          ...
          <div>
            <table>
              <tbody>
                <tr>
                  <td>
                    ${this.state.bookingData.price} x {this.state.tripLength}{" "}
                    night{this.state.tripLength !== 1 ? "s" : ""}
                  </td>
                  <td>
                    ${this.state.bookingData.price * this.state.tripLength}
                  </td>
                </tr>
                <tr>
                  <td>Cleaning Fee</td>
                  <td>
                    $
                    {this.state.bookingData.cleaningFee ||
                      this.state.bookingData.cleaningfee}
                  </td>
                </tr>
                <tr>
                  ...
                  <td>
                    <strong>
                      ...
                      {this.state.bookingData.price * this.state.tripLength +
                        (this.state.bookingData.cleaningFee ||
                          this.state.bookingData.cleaningfee) +
                        Number(this.state.taxes) +
                        Number(this.state.serviceFee)}
                    </strong>
                  </td>
                </tr>
              </tbody>
